...
<div class="container px-6 mx-auto"  in:fade>
  <div
      ...
      <div class="bg-white p-10 flex flex-col w-full shadow-xl rounded-xl">
        ...
        <form action="" class="w-full">
          <div id="input" class="flex flex-col w-full my-5">
            ...
            <input
              bind:value={username}
              on:change={ () => { userError = username.length < 3 ? "Username too short" : null}}
              type="text"
              id="username"
          ...
          <div id="input" class="flex flex-col w-full my-5">
            ...
            <input
              bind:value={password}
              on:change={ () => { passError = password.length < 3 ? "Password too short" : null}}
              type="password"
              id="password"
          ...
          <div id="button" class="flex flex-col w-full my-5">
            <button
              ...
              on:click={() => { !userError && !passError ? window.location.href = "#" : '' }}
            >
